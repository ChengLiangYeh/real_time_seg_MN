#20211201:從cv2_vis_mask.py修改而來的,cv2_vis_mask.py會產出GT和predmask視覺化圖,另外還有儲存參數之csv檔.
...
cwd_mask = Path.cwd()
cwd_mask = cwd_mask / 'SOLO_output_predict_vis_mask'
#print(cwd_mask)
cwd_img = Path.cwd()
cwd_img = cwd_img / 'datasets/0630_split_dataset/1201_normal_all_data/JPEGImages'
#print(cwd_img)
...
import json
with open('./datasets/0630_split_dataset/annotations/1201_normal_all_data_annotations.json', newline='') as jsonfile:
...
pred_mask_dir_path = "./SOLO_output_predict_vis_mask/"
