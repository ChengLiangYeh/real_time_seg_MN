...
def build_augmentation(cfg, is_train):
    ...
    augmentation = [] #0520 findings => augmentation的順序很有差喔


    ###0821 adding by yehcl
    augmentation.append(T.RandomCrop(crop_type='relative_range', crop_size=[0.9, 0.9]))
    ###0821 adding by yehcl

    ###0821 adding by yehcl
    augmentation.append(T.RandomRotation(angle=[-5,5], sample_style='range'))
    ###0821 adding by yehcl
