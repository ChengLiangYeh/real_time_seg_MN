...
from adet.data.dataset_mapper import DatasetMapperWithBasis #data augmentation檔案位置
from adet.config import get_cfg
from adet.checkpoint import AdetCheckpointer
from adet.evaluation import TextEvaluator

#register MN dataset 沒問題
...
register_coco_instances("my_dataset_normal_all_data", {}, "./datasets/0630_split_dataset/annotations/1201_normal_all_data_annotations.json", "./datasets/0630_split_dataset/1201_normal_all_data/")
#0630更正新的dataset
