...
cfg = get_cfg()
cfg.merge_from_file(model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml"))#之前用,R101FPN
...
cfg.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "model_0053439.pth")  # path to the model we just trained
#print(cfg.MODEL.WEIGHTS)
